...
async function initializeDatabase() {
  ...
  await pool.query(`
    ...
    VALUES
      ...
      /*
       * איתן סבן – משאירים כרגע כמו שסגרנו
       */
      (
        'איתן סבן',
        'גלי הדר – ראשון לציון',
  ...
  /*
   * =========================================================
   * ניקוי שיבוצים ישנים ושגויים שכבר קיימים ב-DB
   *
   * לא מוחקים אותם פיזית כדי לא לזרוק מידע ישן.
   * רק מסמנים אותם כלא פעילים.
   * =========================================================
   */
